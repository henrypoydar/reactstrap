...
var Dropdown = function (_React$Component) {
  ...
  createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(reactPopper.Manager, _extends({}, attrs, { className: classes }));
    }
  }]);
  return Dropdown;
  ...
  createClass(PopperContent, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          tag = _props.tag,
          attrs = objectWithoutProperties(_props, ['cssModule', 'children', 'isOpen', 'flip', 'target', 'offset', 'fallbackPlacement', 'placementPrefix', 'className', 'wrapTag', 'wrapClassName', 'tag']);
...
var placements$1 = PopperJS.placements;
  ...
  createClass(Input, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          innerRef = _props.innerRef,
          attributes = objectWithoutProperties(_props, ['className', 'cssModule', 'type', 'size', 'state', 'tag', 'addon', 'static', 'innerRef']);
